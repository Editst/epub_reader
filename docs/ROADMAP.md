...
> v2.4.14 已完成 AN-1、AN-2 与 AN-4；后续保留同文档位置关系与跨文档缓存。
...
| 优先级 | ID | 描述 | 目标版本 | 状态 |
|---|---|---|---|---|
| 🔵 P3 | D-2026-14 | 跨文档注释无缓存 | 后续专项 | 📋 已规划 |
| 🔵 P3 | D-2026-15 | FB2 转换格式注释容器未识别 | v2.5.0 | 📋 已规划 |
| 🔵 P3 | D-2026-16 | `noteTextMarker` 4 位数字年份误判风险 | v2.5.0 | 📋 已规划 |

> 已修复的历史债务（D-2026-01～D-2026-13, D-2026-17～D-2026-25）全部清零，详见 git 历史。
